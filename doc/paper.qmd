...
In the second filtration step firms with adequate consecutive data must be identified. Each firm must have income statement and balance sheet information for at least three consecutive years, with all key accounting variables mentioned above present. If a firm had at least three consecutive years of complete data at any point, all its data entries were retained in the final dataset. The filtration process resulted in the elimination of 8,265 firms and 20,521 firm-year observations. 

Therefore, only those countries and firms that meet these criteria for all specified variables are retained in the dataset.
